"""Generate document_router.py with proper validation"""
...
with open("backend/app/api/document_router.py", "w", encoding="utf-8") as f:
    f.write(content)

print("document_router.py generated successfully")
